...
int main()
{
	...
	CrearCono(18, 0.75f);//índice 3 en MeshList
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		model = glm::rotate(model, mainWindow.getarticulacion4() * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		modelaux2 = model;
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		model = glm::scale(model, glm::vec3(150.0f, 0.55f, 150.0f));
