...
void CrearAla()
{
	...
	Mesh* ala = new Mesh();
	ala->CreateMesh(vertices_ala, indices_ala, 15, 18);
	meshList.push_back(ala);
}

// Ender
void CrearEnder()
{
	GLfloat vertices_ender[] = {
		//X			Y			Z			R		G		B
		// Base azul
	...
	MeshColor* ender = new MeshColor();
	ender->CreateMeshColor(vertices_ender, 108);
	meshColorList.push_back(ender);
}
...
int main()
{
	...
	CrearAla();//índice 1 en MeshList
	CrearCilindro(15, 1.0f);//índice 2 en MeshList
	CrearCono(15, 1.0f);//índice 3 en MeshList
	CrearEnder();//índice 0 en MeshColorList
	CreateShaders();
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::scale(model, glm::vec3(150.0f, 0.5f, 150.0f));
		...
		color = glm::vec3(0.75f, 0.75f, 0.75f);  // Color gris claro
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		// Cohete - Ala 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-6.0f, -2.0f, -9.0f));
		...
		// Ender
		model = glm::mat4(1.0);
		model = glm::scale(model, glm::vec3(0.75f, 0.375f, 0.75f));
		...
		// 4
		model = glm::mat4(1.0);
		model = glm::scale(model, glm::vec3(0.375f, 0.75f, 0.75f));
